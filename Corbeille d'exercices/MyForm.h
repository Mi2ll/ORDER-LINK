...
namespace interfaceprojetpoo {
	...
	private: System::Windows::Forms::NumericUpDown^ new_marge_stat;

	private: System::Windows::Forms::NumericUpDown^ new_tva_stat;


	private: System::Windows::Forms::Button^ button2;
	private: System::Windows::Forms::ComboBox^ pre_demarque_stat;

	private: System::Windows::Forms::ComboBox^ pre_remise_stat;

	private: System::Windows::Forms::ComboBox^ pre_marge_stat;
	private: System::Windows::Forms::ComboBox^ pre_tva_stat;
	...
	private: System::Windows::Forms::NumericUpDown^ demarque_stat;

	private: System::Windows::Forms::NumericUpDown^ remise_stat;

	private: System::Windows::Forms::NumericUpDown^ marge_stat;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->demarque_stat = (gcnew System::Windows::Forms::NumericUpDown());
			this->remise_stat = (gcnew System::Windows::Forms::NumericUpDown());
			this->marge_stat = (gcnew System::Windows::Forms::NumericUpDown());
			this->Simulation = (gcnew System::Windows::Forms::Button());
			this->new_demarque_stat = (gcnew System::Windows::Forms::NumericUpDown());
			this->new_remise_stat = (gcnew System::Windows::Forms::NumericUpDown());
			this->new_marge_stat = (gcnew System::Windows::Forms::NumericUpDown());
			this->new_tva_stat = (gcnew System::Windows::Forms::NumericUpDown());
			this->button2 = (gcnew System::Windows::Forms::Button());
			this->pre_demarque_stat = (gcnew System::Windows::Forms::ComboBox());
			this->pre_remise_stat = (gcnew System::Windows::Forms::ComboBox());
			this->pre_marge_stat = (gcnew System::Windows::Forms::ComboBox());
			this->pre_tva_stat = (gcnew System::Windows::Forms::ComboBox());
			...
			this->mode_paiement = (gcnew System::Windows::Forms::ComboBox());
			...
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->demarque_stat))->BeginInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->remise_stat))->BeginInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->marge_stat))->BeginInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->new_demarque_stat))->BeginInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->new_remise_stat))->BeginInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->new_marge_stat))->BeginInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->new_tva_stat))->BeginInit();
			...
			this->panel1->Size = System::Drawing::Size(1792, 129);
			...
			this->tabControl1->Size = System::Drawing::Size(1792, 878);
			...
			this->Personnel->Size = System::Drawing::Size(1784, 840);
			...
			this->personnel_suivant->Location = System::Drawing::Point(549, 786);
			this->personnel_suivant->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->personnel_suivant->Name = L"personnel_suivant";
			this->personnel_suivant->Size = System::Drawing::Size(72, 31);
			...
			this->personnel_precedent->Location = System::Drawing::Point(417, 786);
			this->personnel_precedent->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->personnel_precedent->Name = L"personnel_precedent";
			this->personnel_precedent->Size = System::Drawing::Size(72, 31);
			...
			// 
			this->btn_select_personnel->Location = System::Drawing::Point(417, 682);
			...
			this->Clients->Size = System::Drawing::Size(1784, 840);
			...
			// Commandes
			// 
			this->Commandes->Controls->Add(this->label45);
			this->Commandes->Controls->Add(this->mode_paiement);
			...
			this->Commandes->Size = System::Drawing::Size(1784, 840);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(290, 785);
			...
			this->label38->Location = System::Drawing::Point(240, 202);
			...
			this->date_livraison->Location = System::Drawing::Point(245, 238);
			this->date_livraison->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->date_livraison->Name = L"date_livraison";
			this->date_livraison->Size = System::Drawing::Size(157, 31);
			this->date_livraison->TabIndex = 71;
			// 
			// label37
			// 
			this->label37->AutoSize = true;
			this->label37->Location = System::Drawing::Point(15, 202);
			...
			this->date_cmd->Location = System::Drawing::Point(20, 238);
			this->date_cmd->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->date_cmd->Name = L"date_cmd";
			this->date_cmd->Size = System::Drawing::Size(156, 31);
			this->date_cmd->TabIndex = 69;
			// 
			// id_client_commande
			// 
			this->id_client_commande->Location = System::Drawing::Point(16, 329);
			...
			this->label23->Location = System::Drawing::Point(10, 535);
			...
			this->dataGridView2->Location = System::Drawing::Point(20, 569);
			...
			// id_commande
			// 
			this->id_commande->Location = System::Drawing::Point(20, 58);
			this->id_commande->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->id_commande->Name = L"id_commande";
			this->id_commande->Size = System::Drawing::Size(381, 31);
			...
			this->article->DropDownStyle = System::Windows::Forms::ComboBoxStyle::DropDownList;
			// 
			...
			// 
			this->btn_modifier_commande->Location = System::Drawing::Point(34, 378);
			...
			this->Stock->Size = System::Drawing::Size(1784, 840);
			...
			this->nature_article->DropDownStyle = System::Windows::Forms::ComboBoxStyle::DropDownList;
			// 
			// tva
			// 
			...
			this->Statistiques->Controls->Add(this->new_demarque_stat);
			this->Statistiques->Controls->Add(this->new_remise_stat);
			this->Statistiques->Controls->Add(this->new_marge_stat);
			this->Statistiques->Controls->Add(this->new_tva_stat);
			this->Statistiques->Controls->Add(this->button2);
			this->Statistiques->Controls->Add(this->pre_demarque_stat);
			this->Statistiques->Controls->Add(this->pre_remise_stat);
			this->Statistiques->Controls->Add(this->pre_marge_stat);
			this->Statistiques->Controls->Add(this->pre_tva_stat);
			...
			this->Statistiques->Size = System::Drawing::Size(1784, 840);
			this->Statistiques->TabIndex = 4;
			this->Statistiques->Text = L"Statistiques";
			this->Statistiques->UseVisualStyleBackColor = true;
			this->Statistiques->Click += gcnew System::EventHandler(this, &MainForm::Statistiques_Click);
			// 
			// demarque_stat
			// 
			this->demarque_stat->Location = System::Drawing::Point(66, 532);
			this->demarque_stat->Margin = System::Windows::Forms::Padding(3, 5, 3, 5);
			this->demarque_stat->Maximum = System::Decimal(gcnew cli::array< System::Int32 >(4) { 99, 0, 0, 0 });
			this->demarque_stat->Name = L"demarque_stat";
			this->demarque_stat->Size = System::Drawing::Size(135, 31);
			this->demarque_stat->TabIndex = 185;
			// 
			// remise_stat
			// 
			this->remise_stat->Location = System::Drawing::Point(66, 462);
			this->remise_stat->Margin = System::Windows::Forms::Padding(3, 5, 3, 5);
			this->remise_stat->Maximum = System::Decimal(gcnew cli::array< System::Int32 >(4) { 99, 0, 0, 0 });
			this->remise_stat->Name = L"remise_stat";
			this->remise_stat->Size = System::Drawing::Size(135, 31);
			this->remise_stat->TabIndex = 184;
			// 
			// marge_stat
			// 
			this->marge_stat->Location = System::Drawing::Point(66, 388);
			this->marge_stat->Margin = System::Windows::Forms::Padding(3, 5, 3, 5);
			this->marge_stat->Maximum = System::Decimal(gcnew cli::array< System::Int32 >(4) { 99, 0, 0, 0 });
			this->marge_stat->Minimum = System::Decimal(gcnew cli::array< System::Int32 >(4) { 1, 0, 0, 0 });
			this->marge_stat->Name = L"marge_stat";
			this->marge_stat->Size = System::Drawing::Size(135, 31);
			this->marge_stat->TabIndex = 183;
			this->marge_stat->ThousandsSeparator = true;
			this->marge_stat->Value = System::Decimal(gcnew cli::array< System::Int32 >(4) { 1, 0, 0, 0 });
			// 
			// Simulation
			// 
			...
			this->Simulation->Click += gcnew System::EventHandler(this, &MainForm::Simulation_Click);
			// 
			// new_demarque_stat
			// 
			this->new_demarque_stat->Location = System::Drawing::Point(624, 529);
			this->new_demarque_stat->Margin = System::Windows::Forms::Padding(3, 5, 3, 5);
			this->new_demarque_stat->Name = L"new_demarque_stat";
			this->new_demarque_stat->Size = System::Drawing::Size(135, 31);
			this->new_demarque_stat->TabIndex = 181;
			// 
			// new_remise_stat
			// 
			this->new_remise_stat->Location = System::Drawing::Point(624, 458);
			this->new_remise_stat->Margin = System::Windows::Forms::Padding(3, 5, 3, 5);
			this->new_remise_stat->Name = L"new_remise_stat";
			this->new_remise_stat->Size = System::Drawing::Size(135, 31);
			this->new_remise_stat->TabIndex = 180;
			// 
			// new_marge_stat
			// 
			this->new_marge_stat->Location = System::Drawing::Point(624, 385);
			this->new_marge_stat->Margin = System::Windows::Forms::Padding(3, 5, 3, 5);
			this->new_marge_stat->Name = L"new_marge_stat";
			this->new_marge_stat->Size = System::Drawing::Size(135, 31);
			this->new_marge_stat->TabIndex = 179;
			// 
			// new_tva_stat
			// 
			this->new_tva_stat->Location = System::Drawing::Point(624, 309);
			this->new_tva_stat->Margin = System::Windows::Forms::Padding(3, 5, 3, 5);
			this->new_tva_stat->Name = L"new_tva_stat";
			this->new_tva_stat->Size = System::Drawing::Size(135, 31);
			this->new_tva_stat->TabIndex = 178;
			// 
			// button2
			// 
			...
			// pre_demarque_stat
			// 
			this->pre_demarque_stat->FormattingEnabled = true;
			this->pre_demarque_stat->Items->AddRange(gcnew cli::array< System::Object^  >(3) { L"2", L"3", L"5" });
			this->pre_demarque_stat->Location = System::Drawing::Point(356, 531);
			this->pre_demarque_stat->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->pre_demarque_stat->Name = L"pre_demarque_stat";
			this->pre_demarque_stat->Size = System::Drawing::Size(170, 33);
			this->pre_demarque_stat->TabIndex = 176;
			this->pre_demarque_stat->DropDownStyle = System::Windows::Forms::ComboBoxStyle::DropDownList;
			// 
			// pre_remise_stat
			// 
			this->pre_remise_stat->FormattingEnabled = true;
			this->pre_remise_stat->Items->AddRange(gcnew cli::array< System::Object^  >(2) { L"5", L"6" });
			this->pre_remise_stat->Location = System::Drawing::Point(354, 455);
			this->pre_remise_stat->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->pre_remise_stat->Name = L"pre_remise_stat";
			this->pre_remise_stat->Size = System::Drawing::Size(170, 33);
			this->pre_remise_stat->TabIndex = 175;
			this->pre_remise_stat->DropDownStyle = System::Windows::Forms::ComboBoxStyle::DropDownList;
			// 
			// pre_marge_stat
			// 
			this->pre_marge_stat->FormattingEnabled = true;
			this->pre_marge_stat->Items->AddRange(gcnew cli::array< System::Object^  >(3) { L"5", L"10", L"15" });
			this->pre_marge_stat->Location = System::Drawing::Point(354, 382);
			this->pre_marge_stat->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->pre_marge_stat->Name = L"pre_marge_stat";
			this->pre_marge_stat->Size = System::Drawing::Size(170, 33);
			this->pre_marge_stat->TabIndex = 174;
			this->pre_marge_stat->DropDownStyle = System::Windows::Forms::ComboBoxStyle::DropDownList;
			// 
			// pre_tva_stat
			// 
			this->pre_tva_stat->FormattingEnabled = true;
			this->pre_tva_stat->Items->AddRange(gcnew cli::array< System::Object^  >(3) { L"20", L"5", L"2" });
			this->pre_tva_stat->Location = System::Drawing::Point(354, 309);
			this->pre_tva_stat->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->pre_tva_stat->Name = L"pre_tva_stat";
			this->pre_tva_stat->Size = System::Drawing::Size(170, 33);
			this->pre_tva_stat->TabIndex = 173;
			this->pre_tva_stat->DropDownStyle = System::Windows::Forms::ComboBoxStyle::DropDownList;
			// 
			// label42
			// 
			...
			this->label49->Location = System::Drawing::Point(351, 282);
			...
			this->groupBox4->Location = System::Drawing::Point(926, 685);
			...
			this->id_client_statistique->Size = System::Drawing::Size(254, 31);
			...
			this->groupBox3->Location = System::Drawing::Point(20, 182);
			...
			this->use_default_param->Checked = true;
			...
			this->use_custom_param->Location = System::Drawing::Point(484, 34);
			...
			this->groupBox2->Location = System::Drawing::Point(20, 669);
			...
			this->label40->Location = System::Drawing::Point(304, 46);
			...
			// btn_mostpopular
			// 
			this->btn_mostpopular->Location = System::Drawing::Point(1479, 562);
			this->btn_mostpopular->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->btn_mostpopular->Name = L"btn_mostpopular";
			this->btn_mostpopular->Size = System::Drawing::Size(232, 91);
			...
			// btn_lesspopular
			// 
			this->btn_lesspopular->Location = System::Drawing::Point(1239, 562);
			this->btn_lesspopular->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->btn_lesspopular->Name = L"btn_lesspopular";
			this->btn_lesspopular->Size = System::Drawing::Size(232, 91);
			...
			this->groupBox1->Location = System::Drawing::Point(20, 29);
			this->groupBox1->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->groupBox1->Name = L"groupBox1";
			this->groupBox1->Padding = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->groupBox1->Size = System::Drawing::Size(870, 122);
			...
			// chiffre_affaire
			// 
			this->chiffre_affaire->Location = System::Drawing::Point(308, 54);
			...
			// 
			this->btn_select_item_in_reap->Location = System::Drawing::Point(996, 562);
			...
			this->btn_select_item_in_reap->Size = System::Drawing::Size(232, 91);
			...
			this->dataGridView6->Location = System::Drawing::Point(926, 25);
			...
			this->dataGridView6->Size = System::Drawing::Size(842, 518);
			this->dataGridView6->TabIndex = 138;
			// 
			// mode_paiement
			// 
			this->mode_paiement->FormattingEnabled = true;
			this->mode_paiement->Location = System::Drawing::Point(17, 147);
			this->mode_paiement->Name = L"mode_paiement";
			this->mode_paiement->Size = System::Drawing::Size(382, 33);
			this->mode_paiement->TabIndex = 74;
			this->mode_paiement->Items->Add("Carte Bleue");
			this->mode_paiement->Items->Add("Chèque");
			this->mode_paiement->Items->Add("Virement");
			this->mode_paiement->Items->Add("Espèces");
			this->mode_paiement->DropDownStyle = System::Windows::Forms::ComboBoxStyle::DropDownList;
			// 
			// label45
			// 
			this->label45->AutoSize = true;
			this->label45->Location = System::Drawing::Point(15, 109);
			this->label45->Name = L"label45";
			this->label45->Size = System::Drawing::Size(170, 25);
			this->label45->TabIndex = 75;
			this->label45->Text = L"Mode de Paiement";
			// 
			// MainForm
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(9, 20);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(1792, 1038);
			...
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->demarque_stat))->EndInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->remise_stat))->EndInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->marge_stat))->EndInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->new_demarque_stat))->EndInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->new_remise_stat))->EndInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->new_marge_stat))->EndInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->new_tva_stat))->EndInit();
...
#pragma endregion
	...
	private: System::Void btn_ajouter_commande_Click(System::Object^ sender, System::EventArgs^ e) {
		int id;
		id = this->oSvcCommande->ajouterUneCommande(this->date_cmd->Text, this->date_livraison->Text, Int32::Parse(this->id_client_commande->Text), this->mode_paiement->Text);
...
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	int valeur_achat = this->oSvcStats->ValeurAchatStock(this->marge_stat->Text, this->remise_stat->Text, this->demarque_stat->Text);
...
private: System::Void Statistiques_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	private: System::Void Simulation_Click(System::Object^ sender, System::EventArgs^ e) {
		int valeur_commerciale = this->oSvcStats->ValeurCommercialStock();
		this->valeur_co__stat->Text = Convert::ToString(valeur_commerciale) + "€";

		System::String^ tva_var;
		System::String^ marge_var;
		System::String^ remise_var;
		System::String^ demarque_var;

		if (use_default_param->Checked) {
			tva_var = pre_tva_stat->Text;
			marge_var = pre_marge_stat->Text;
			remise_var = pre_remise_stat->Text;
			demarque_var = pre_demarque_stat->Text;
		}
		else {
			tva_var = this->new_tva_stat->Text;
			marge_var = this->new_marge_stat->Text;
			remise_var = this->new_remise_stat->Text;
			demarque_var = this->new_demarque_stat->Text;
		}

		System::String^ marge_modif = Convert::ToString(round(Convert::ToInt32(this->marge_stat->Text) * Convert::ToSingle("1," + marge_var)));
		System::String^ remise_modif = Convert::ToString(round(Convert::ToInt32(this->remise_stat->Text) * Convert::ToSingle("1," + remise_var)));
		System::String^ demarque_modif = Convert::ToString(round(Convert::ToInt32(this->demarque_stat->Text) * Convert::ToSingle("1," + demarque_var)));

		int valeur_achat = this->oSvcStats->Simulation(valeur_commerciale, tva_var, marge_var, remise_var, demarque_var);
		this->valeur_achat__stat->Text = Convert::ToString(valeur_achat);
