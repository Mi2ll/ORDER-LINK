...
void NS_Comp_Svc::CLservicesCommande::ajouterLigneCommande(System::String^ article, int id_commande, int qte_commandee) {
	...
	// application de la r�duction (15% / 10% / 5%)

	// R�cup�rer l'id du client qui a fait la commande
	...
	// Nombre de commandes qu'a effectu� le client
	...
	// Check si la commande a �t� r�alis� le jour de naissance du client
...
int NS_Comp_Svc::CLservicesCommande::hasReduction(int id_client, System::String^ date_commande) {
	...
	// Obtention les 5 derniers caract�res
