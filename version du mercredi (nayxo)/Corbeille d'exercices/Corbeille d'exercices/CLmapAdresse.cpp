...
System::String^ NS_Comp_Mappage::CLmapAdresse::Select(void) {
	return "SELECT id_adresse from Adresse WHERE numero = '" + this->numero + "' and rue = '" + this->nom_rue + "' and code_postal = '" + this->code_postal + "' and ville = '" + this->ville + "'; ";
}
